...
banner="""
             ...
             | / __|_ __  __ _ __ __                     |
             | \__ \ '_ \/ _` |  '  |                    |
             | |___/ .__/\__,_|_|√|_| V2 By User91       |
             |     |_|                                   |
             |                                           |
             | Script spam sms, call, WA                 |
             |                                           |
             |     ×-------------------------------×     |
             |     ' Creator: User91               '     |
             |     ' Youtube: ArieSR91             '     |
...
no=input("\033[1;97m[\033[1;96m•\033[1;97m]No Target\033[90m(\033[1;94m+62\033[90m)\033[1;97m:\033[1;94m ")
...
def wa():
    ...
    if "OTP Terkirim" in (r):
        ...
        sys.exit("\033[1;97m[\033[1;91m✓\033[1;97m]\033[1;91mSucceess\033[00m")
def cal1():
    ua={
