#Author : Syahri Ramadhan 91
#Github : Arie-SR91
#Youtube
clear
sleep 2.1
echo '[31;1m                        `/ymMMMMMMMMmy/`'
...
echo '            -h/+s/MmMMMNmNNNdym++mymNNNmNMMNmM:so/h-[37;1m'
...
echo '                   :hds+/-`          `-/+sdh:'
echo '                     `/ymM+          oMmy:'
echo '                         [41m W E L C O M E [0m'
echo ''
echo '[1;36m                     =[ [1;37mUsername [1;33m:[1;32m user91 [1;36m]='
echo '[1;37m                  ====[ [1;32mPassword : ****** [1;37m]===='
echo ''
PS1='[1;34m\]╭───\[[1;31m\]≼\[[1;33m\]user91\[[1;34m\]•\[[1;30m\]\w\[[1;34m\]≽ 
\[[1;34m\]╰──╼\[[1;31m\]✠\[[1;32m\] ' 
