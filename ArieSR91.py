...
def sukses():
    ...
    if pilih == "1":
       os.system("pkg update && pkg upgrade && pkg install python && pkg install python2 && pkg install wget && pkg install curl && pkg install git && pkg install ruby && pkg install lolcat && pkg install php && pkg install neofetch && pkg install nano && pkg install perl && pkg install nodejs && pkg install micro && pkg install joe && pkg install vim && pkg install jupp && pkg install && pkg install zile && pkg install ne && pkg install figlet && pkg install toilet && pkg install fish && pkg install cowsay && pkg install metasploit && gem install ruby && pip install bs4 && python -m pip install requests && pip install requests && pip install mechanize && pip2 install --upgrade pip && pip2 install mechanize && pip2 install requests")
       os.system("clear")
    if pilih == "2":
